...
import { FileHandlerStatus, ChunkStatus } from './model';
var FileHandler = /** @class */ (function () {
    function FileHandler(options) {
        this.filename = '';
        this.size = 0;
        this.status = FileHandlerStatus.INITIAL;
        this.chunks = [];
        this.precent = 0;
        this.hash = '';
        this.id = '';
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        this.emitStatus();
                        _a = this;
                        return [4 /*yield*/, getFileHash(this.file)];
                    case 2:
                        _a.hash = _c.sent();
                        _c.label = 3;
                    case 3:
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, getBlobHash(fileSlice)];
                                    case 1:
                                        sliceHash = _c.sent();
                                        ...
                                        if (chunk.status !== ChunkStatus.COMPLETE) {
                                            ...
                                            response.then(function (res) {
                                                ...
                                                chunk.status = _this.status === FileHandlerStatus.SUSPEND ? ChunkStatus.CANCEL : ChunkStatus.FAIL;
                                                chunk.xhr = null;
                                                _this.chunkUpdate();
                                            });
                                        }
    ...
    FileHandler.prototype.updateStatus = function () {
        if (this.status === FileHandlerStatus.SUSPEND && this.chunks.some(function (item) { return item.status === ChunkStatus.CANCEL; })) {
            this.status = FileHandlerStatus.SUSPEND;
        }
        if (this.chunks.some(function (item) { return item.status === ChunkStatus.UPLOADING; })) {
            this.status = FileHandlerStatus.UPLOADING;
        }
        else if (this.chunks.some(function (item) { return item.status === ChunkStatus.FAIL; })) {
            this.status = FileHandlerStatus.FAIL;
        }
        else if (this.chunks.every(function (item) { return item.status === ChunkStatus.COMPLETE; })) {
    ...
    FileHandler.prototype.pause = function () {
        this.chunks.filter(function (item) { return item.status === ChunkStatus.UPLOADING; })
